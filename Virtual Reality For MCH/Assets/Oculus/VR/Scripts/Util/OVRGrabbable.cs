...
public class OVRGrabbable : MonoBehaviour
{
    ...
    [SerializeField] private GameObject InfoIconA;

    [SerializeField] private GameObject ChekaInfo;
    bool isStartInfo = true;

    [SerializeField] private Material materiaLine;

    public bool isExecuter = false;
    [SerializeField] private GameObject ChekaForExecuter;
	...
	virtual public void GrabBegin(OVRGrabber hand, Collider grabPoint)
    {
        ...
        if (isExecuter)
        {
            for (int i = 0; i < 2; i++)
            {
                sphereEndLine[i].SetActive(false);
                LineRender[i].SetActive(false);
                LineRender[i].gameObject.GetComponent<Renderer>().material.color = Color.white;
            }
    ...
    private IEnumerator ChekaInformation()
    {
        ChekaInfo.SetActive(true);
